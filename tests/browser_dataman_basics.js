...
function test() {
  ...
  // addons.mozilla.org to install addons as well as permissions for a number
  // of sites used in mochitest to load XUL/XBL.
...
function test_permissions_panel(aWin) {
  ...
  is(aWin.gPerms.list.children.length, 17,
